...
use openduck::providers::api_client::{ApiClient, AuthMethod};
use openduck::providers::base::Provider;
use openduck::providers::openai::OpenAiProvider;
use openduck::session_context::{session_id_request_builder, SESSION_ID_HEADER};
...
async fn make_request(provider: &dyn Provider, session_id: &str) {
    ...
    let _ = openduck::session_context::with_session_id(
