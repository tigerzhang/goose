...
use openduck::agents::{Agent, AgentEvent, GoosePlatform};
use openduck::config::extensions::{set_extension, ExtensionEntry};
...
mod tests {
    ...
    mod schedule_tool_tests {
        ...
        use openduck::agents::platform_extensions::scheduler::{
            EXTENSION_NAME as SCHEDULER_EXTENSION_NAME, MANAGE_SCHEDULE_TOOL_NAME_COMPLETE,
        };
        use openduck::agents::ExtensionConfig;
        use openduck::agents::{AgentConfig, ScheduleTool};
        use openduck::config::permission::PermissionManager;
        use openduck::config::GooseMode;
        use openduck::scheduler::{ScheduledJob, SchedulerError, ValidatedScheduleRecipe};
        use openduck::scheduler_trait::SchedulerTrait;
        use openduck::session::{Session, SessionManager};
    ...
    mod retry_tests {
        use super::*;
        use openduck::agents::types::{RetryConfig, SuccessCheck};

        #[tokio::test]
        async fn test_retry_success_check_execution() -> Result<()> {
            use openduck::agents::retry::execute_success_checks;
    ...
    mod max_turns_tests {
        use super::*;
        use async_trait::async_trait;
        use openduck::agents::SessionConfig;
        use openduck::config::GooseMode;
        use openduck::conversation::message::{Message, MessageContent};
        use openduck::providers::base::{
            stream_from_single_message, MessageStream, Provider, ProviderDef, ProviderMetadata,
        };
        use openduck::session::session_manager::SessionType;
        use openduck_providers::conversation::token_usage::{ProviderUsage, Usage};
        ...
        impl openduck::providers::base::ProviderDescriptor for MockToolProvider {
        ...
        impl ProviderDef for MockToolProvider {
            ...
            fn from_env(
                _extensions: Vec<openduck::config::ExtensionConfig>,
                _tls_config: Option<openduck::providers::api_client::TlsConfig>,
            ...
            while let Some(response_result) = reply_stream.next().await {
                match response_result {
                    Ok(AgentEvent::Message(response)) => {
                        ...
                        {
                            if let openduck::conversation::message::ActionRequiredData::ToolConfirmation { id, .. } = &action.data {
                                agent.handle_confirmation(
                                    id.clone(),
                                    openduck::permission::PermissionConfirmation {
                                        principal_type: openduck::permission::permission_confirmation::PrincipalType::Tool,
                                        permission: openduck::permission::Permission::AllowOnce,
                                    }
                                ).await;
                            }
                        }
    ...
    mod unparseable_tool_call_tests {
        use super::*;
        use async_trait::async_trait;
        use openduck::agents::{AgentConfig, SessionConfig};
        use openduck::config::permission::PermissionManager;
        use openduck::config::GooseMode;
        use openduck::conversation::message::{Message, MessageContent};
        use openduck::providers::base::{
        ...
        impl openduck::providers::base::ProviderDescriptor for UnparseableToolProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod tool_pair_summarization_tests {
        ...
        use async_trait::async_trait;
        use openduck::agents::{AgentConfig, SessionConfig};
        use openduck::config::base::Config;
        use openduck::config::permission::PermissionManager;
        use openduck::config::GooseMode;
        use openduck::conversation::message::Message;
        use openduck::providers::base::{
            stream_from_single_message, MessageStream, Provider, ProviderDef, ProviderMetadata,
        };
        use openduck::session::{SessionManager, SessionType};
        use openduck_providers::conversation::token_usage::{ProviderUsage, Usage};
        use openduck_providers::errors::ProviderError;
        use openduck_providers::model::ModelConfig;
        ...
        impl openduck::providers::base::ProviderDescriptor for SummarizationTestProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod extension_manager_tests {
        use super::*;
        use openduck::agents::extension::ExtensionConfig;
        use openduck::agents::platform_extensions::{
            MANAGE_EXTENSIONS_TOOL_NAME, SEARCH_AVAILABLE_EXTENSIONS_TOOL_NAME,
        };
        use openduck::agents::AgentConfig;
        use openduck::config::permission::PermissionManager;
        use openduck::config::GooseMode;
        use openduck::session::SessionManager;
    ...
    mod streaming_persistence_tests {
        ...
        use openduck::config::GooseMode;
        use openduck::conversation::message::Message;
        use openduck::providers::base::{MessageStream, Provider, ProviderDef, ProviderMetadata};
        use openduck::session::session_manager::SessionType;
        use openduck::session::SessionManager;
        use openduck_providers::conversation::token_usage::{ProviderUsage, Usage};
        use openduck_providers::errors::ProviderError;
        ...
        impl openduck::providers::base::ProviderDescriptor for MultiStepProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod thinking_preservation_tests {
        ...
        impl openduck::providers::base::ProviderDescriptor for ThinkingStreamProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        fn assert_formatter_adds_reasoning_to_tool_calls(messages: &[Message], provider: &str) {
            use openduck_providers::formats::openai::{
                format_messages_with_options, OpenAiFormatOptions,
            };
            use openduck_providers::images::ImageFormat;
        ...
        impl openduck::providers::base::ProviderDescriptor for CombinedThinkingToolProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        impl openduck::providers::base::ProviderDescriptor for MultiToolThinkingProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        async fn test_signed_thinking_not_duplicated_for_anthropic() -> Result<()> {
            use openduck_providers::formats::anthropic::format_messages as anthropic_format;
    ...
    mod goal_checking_tests {
        ...
        impl openduck::providers::base::ProviderDescriptor for GoalTextProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod cumulative_token_tests {
        ...
        use openduck::config::GooseMode;
        use openduck::conversation::message::Message;
        use openduck::providers::base::{stream_from_single_message, MessageStream, Provider};
        use openduck::session::session_manager::SessionType;
        use openduck::session::SessionManager;
        use openduck_providers::conversation::token_usage::{ProviderUsage, Usage};
        use openduck_providers::errors::ProviderError;
    ...
    mod frontend_extension_tests {
        use super::*;
        use openduck::agents::{AgentConfig, ExtensionConfig};
        use openduck::config::permission::PermissionManager;
        use openduck::config::GooseMode;
        use openduck::session::session_manager::SessionType;
        use openduck::session::{
    ...
    mod audience_tool_result_tests {
        ...
        use async_trait::async_trait;
        use openduck::agents::{AgentConfig, SessionConfig};
        use openduck::config::{ExtensionConfig, GooseMode, PermissionManager};
        use openduck::conversation::message::{Message, MessageContent};
        use openduck::providers::base::{stream_from_single_message, MessageStream, Provider};
        use openduck::session::{SessionManager, SessionType};
        use openduck_providers::conversation::token_usage::{ProviderUsage, Usage};
        use openduck_providers::errors::ProviderError;
        use openduck_providers::model::ModelConfig;
        use openduck_test_support::McpFixture;
        use rmcp::model::{CallToolRequestParams, Tool};
        use std::path::PathBuf;
        use std::sync::atomic::{AtomicUsize, Ordering};
    ...
    mod empty_turn_tests {
        use super::*;
        use async_trait::async_trait;
        use openduck::agents::final_output_tool::FINAL_OUTPUT_TOOL_NAME;
        use openduck::agents::{AgentConfig, AgentEvent, GoosePlatform, SessionConfig};
        use openduck::config::permission::PermissionManager;
        use openduck::config::GooseMode;
        use openduck::conversation::message::{Message, MessageContent};
        use openduck::conversation::Conversation;
        use openduck::providers::base::{
            stream_from_single_message, MessageStream, Provider, ProviderDef, ProviderMetadata,
        };
        use openduck::session::session_manager::SessionType;
        ...
        impl openduck::providers::base::ProviderDescriptor for AssistantOnlyProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        impl openduck::providers::base::ProviderDescriptor for EmptyThenTextProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        async fn test_empty_turn_with_final_output_tool_nudges() -> Result<()> {
            use openduck::agents::final_output_tool::FINAL_OUTPUT_CONTINUATION_MESSAGE;
            use openduck::recipe::Response;
