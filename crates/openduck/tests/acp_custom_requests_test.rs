...
use openduck_test_support::{EnforceSessionId, IgnoreSessionId};
...
fn write_acp_global_config(contents: &str) -> PathBuf {
    ...
    let config_dir = openduck::config::paths::Paths::config_dir();
...
fn test_custom_get_extensions() {
    ...
    run_test(async move {
        ...
        let stored_inline_token = openduck::config::Config::global()
