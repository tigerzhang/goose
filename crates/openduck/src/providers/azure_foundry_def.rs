...
use openduck_providers::api_client::{AuthMethod, AuthProvider, TlsConfig};
use openduck_providers::azure_foundry::{endpoint_kind, AzureFoundryProvider, EndpointKind};
