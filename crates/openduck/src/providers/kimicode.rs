...
use openduck_providers::formats::anthropic::AnthropicFormatOptions;
...
impl KimiCodeProvider {
    ...
    async fn post(&self, payload: &Value) -> Result<reqwest::Response, ProviderError> {
        ...
        openduck_providers::http_status::send_bounded(
            request,
...
impl openduck_providers::base::ProviderDescriptor for KimiCodeProvider {
    fn metadata() -> ProviderMetadata {
        ...
        .with_setup_steps(vec![
            "Run `openduck configure` and select 'Kimi Code'",
