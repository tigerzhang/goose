...
use openduck_providers::formats::openai::is_openai_responses_model;
...
use openduck_providers::formats::openai::{create_request, get_usage, response_to_message};
use openduck_providers::formats::openai_responses::create_responses_request;
...
use openduck_providers::request_log::{start_log, LoggerHandleExt};
...
impl openduck_providers::base::ProviderDescriptor for GithubCopilotProvider {
    fn metadata() -> ProviderMetadata {
        ProviderMetadata::new(
            GITHUB_COPILOT_PROVIDER_NAME,
            "GitHub Copilot",
            "GitHub Copilot. Run `openduck configure` and select copilot to set up.",
