pub mod anthropic {
    pub use openduck_providers::formats::anthropic::*;
}
#[cfg(feature = "aws-providers")]
pub mod bedrock;
pub mod databricks {
    pub use openduck_providers::formats::databricks::*;
}
pub mod gcpvertexai;
pub mod google {
    use anyhow::Result;
    use openduck_providers::conversation::message::Message;
    pub use openduck_providers::formats::google::*;
...
pub mod openrouter;
pub mod snowflake {
    pub use openduck_providers::formats::snowflake::*;
}
