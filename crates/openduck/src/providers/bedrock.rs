...
use openduck_providers::formats::openai::extract_reasoning_effort;
...
impl BedrockProvider {
    ...
    async fn post_mantle_streaming(
        ...
        let response = openduck_providers::http_status::send_bounded(
            req,
...
impl openduck_providers::base::ProviderDescriptor for BedrockProvider {
...
mod tests {
    use super::*;
    use openduck_providers::base::ProviderDescriptor as _;
