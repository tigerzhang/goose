...
use openduck_providers::cache_semantics::apply_chat_payload_breakpoints;
...
impl openduck_providers::base::ProviderDescriptor for LiteLLMProvider {
...
impl Provider for LiteLLMProvider {
    ...
    async fn stream(
        ...
        let mut payload = openduck_providers::formats::openai::create_request(
            model_config,
            system,
            messages,
            tools,
        ...
        let message = openduck_providers::formats::openai::response_to_message(&response)?;
        let usage = openduck_providers::formats::openai::get_usage(&response);
