...
pub mod amp_acp;
pub mod anthropic {
    pub use openduck_providers::anthropic::*;
}
pub mod anthropic_def;
pub mod api_client {
    pub use openduck_providers::api_client::*;
}
pub mod avian;
pub mod azure;
...
pub mod bedrock;
pub mod canonical {
    pub use openduck_providers::canonical::*;
}
...
pub mod google {
    pub use openduck_providers::google::*;
}
pub mod google_def;
pub mod http_status {
    pub use openduck_providers::http_status::*;
}
pub mod huggingface;
...
pub mod ollama {
    pub use openduck_providers::ollama::*;
}
pub mod ollama_cloud;
pub mod ollama_def;
pub mod openai {
    pub use openduck_providers::openai::*;
}
pub mod openai_compatible {
    pub use openduck_providers::openai_compatible::*;
}
pub mod openrouter;
pub mod pi_acp;
...
mod retry {
    pub use openduck_providers::retry::*;
}
pub mod openai_def;
#[cfg(feature = "aws-providers")]
pub mod sagemaker_tgi;
pub mod snowflake {
    pub use openduck_providers::snowflake::*;
}
