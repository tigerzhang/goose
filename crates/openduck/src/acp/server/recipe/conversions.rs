...
use openduck_sdk_types::custom_requests::{
...
) -> Result<openduck_sdk_types::custom_requests::RecipeListEntryDto> {
    Ok(openduck_sdk_types::custom_requests::RecipeListEntryDto {
        id,
