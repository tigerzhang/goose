pub use openduck_context_management::structured;
...
use anyhow::Result;
use indoc::indoc;
use openduck_providers::conversation::token_usage::ProviderUsage;
...
pub use openduck_context_management::DEFAULT_COMPACTION_THRESHOLD;
...
impl openduck_context_management::CompactionModel for GooseCompactionModel<'_> {
    async fn complete(
        &self,
        system: &str,
        messages: &[Message],
...
#[async_trait::async_trait]
impl openduck_context_management::TokenEstimator for GooseTokenEstimator {
...
fn compaction_templates() -> Result<openduck_context_management::Templates> {
    Ok(openduck_context_management::Templates {
...
async fn do_compact(
    ...
    let summary = openduck_context_management::summarize(
        &model,
...
pub use openduck_context_management::format_message_for_compacting;
...
mod tests {
    ...
    use openduck_providers::conversation::token_usage::Usage;
