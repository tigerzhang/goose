...
use openduck_providers::conversation::token_usage::{
        ...
        if !provider.manages_own_context() {
            ...
            loop {
                match stream.next().await {
                    ...
                    Some(Err(error))
                        if openduck_providers::retry::should_retry(&error, &retry_config)
...
mod tests {
    ...
    use openduck_providers::conversation::token_usage::{ProviderStats, ProviderUsage, Usage};
    use openduck_providers::model::ModelConfig;
    ...
    impl Provider for SequencedProvider {
        ...
        fn retry_config(&self) -> openduck_providers::retry::RetryConfig {
            openduck_providers::retry::RetryConfig::new(2, 0, 1.0, 0)
        }
