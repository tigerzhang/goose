...
use openduck::agents::{Agent, AgentEvent, ExtensionConfig, SessionConfig};
use openduck::config::{GooseMode, DEFAULT_EXTENSION_DESCRIPTION, DEFAULT_EXTENSION_TIMEOUT};
