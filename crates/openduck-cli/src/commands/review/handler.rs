...
use openduck::checks::{discover, DiscoveredReview};
use openduck::subprocess::git_command;
...
/// `discovery_root` so [`openduck::checks::discover`] doesn't double-
