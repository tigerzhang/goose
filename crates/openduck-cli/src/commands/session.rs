...
#[cfg(feature = "nostr")]
use openduck::session::nostr_share;
...
pub async fn handle_session_import(input: String, nostr: bool) -> Result<()> {
    ...
    let format = openduck::session::import_formats::detect_format(&json);
    let label = match format {
        openduck::session::import_formats::ImportFormat::Goose => "goose",
        openduck::session::import_formats::ImportFormat::ClaudeCode => "Claude Code",
        openduck::session::import_formats::ImportFormat::Codex => "Codex",
        openduck::session::import_formats::ImportFormat::Pi => "Pi",
    };
