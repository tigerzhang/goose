...
| [OpenCode Zen](https://opencode.ai/zen)                                     | Curated coding models (Claude, GPT, Gemini, free models, and more) via OpenCode’s OpenAI-compatible Zen gateway. See the [OpenCode Zen guide](/docs/guides/opencode-zen).                                                | `OPENCODE_API_KEY`                                                                                                                                                                  |
